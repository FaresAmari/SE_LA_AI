      ...
      <section style={{
        ...
        <div>
          <div style={{
            ...
            <img src="/logo.png" alt="Bayou Innovation Hub Logo" style={{ width: "100%", display: "block" }} />
          </div>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#111", marginBottom: "20px" }}>
              Fares Amari
            </h3>
            ...
            {[
              ...
              <div key={item.label} style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
                ...
                <div>
                  <p style={{ fontSize: "0.75rem", color: "#888", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em", margin: 0 }}>
                    {item.label}
                  </p>
                  <a href={item.href} style={{ color: "#111", fontWeight: 600, textDecoration: "none", fontSize: "0.95rem" }}>
                    {item.value}
                  </a>
                </div>
              </div>
            ...
            <div style={{ marginTop: "24px", paddingTop: "24px", borderTop: "1px solid #f0f0f0" }}>
              <p style={{ fontSize: "0.75rem", color: "#888", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "12px" }}>
                Follow Us
              </p>
              <a href="https://www.tiktok.com/@yourhandle" target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "#010101", color: "white", padding: "10px 20px", borderRadius: "8px", fontWeight: 700, textDecoration: "none", fontSize: "0.9rem" }}>🎵 TikTok</a>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: "1.4rem", fontWeight: 800, color: "#111", marginBottom: "8px" }}>
            Send a Message
          </h2>
